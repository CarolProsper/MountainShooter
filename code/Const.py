...
ENTITY_SHOT_DELAY = {  # delay dos tiros (distância)
    'Player1': 20,
    'Player2': 15,
    'Enemy1': 100,
    'Enemy2': 200.
...
# P
PLAYER_KEY_UP = {'Player1': pygame.K_UP,  # descriminando as teclas dos movimentos de cada jogador
                 'Player2': pygame.K_w}
...
# S
SCORE_POS = {'Title': (WIN_WIDTH / 2, 50),  # centralizando, altura 50...
